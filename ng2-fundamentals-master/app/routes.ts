...
import { EventListComponent, 
    ...
    EventsListResolver,CreateSessionComponent,EventsResolver } from './events/index'
    

export const appRoutes: Routes = [
    { path: 'events/new', component: CreateEventComponent, canDeactivate: ['canDeactivateCreateEvent'] },
    { path: 'events', component: EventListComponent, resolve: { evnt: EventsListResolver } },
    { path: 'events/:id', component: EventDetailsComponent, resolve: {event:EventsResolver} },//this is route gaurd
...
app/user/user.module#UserModule it has two part divided by # 1. is app target module and 
